    ...
    <div className="bot-panel glass animate-fade-in" style={{ animationDelay: '0.1s' }}>
      ...
      <section className="input-group">
        ...
        {isBulk ? (
          ...
          <div className="input-row">
            ...
            />
            <button className="toggle-visibility" onClick={() => setShowToken(!showToken)}>
      ...
      <section className="input-group">
        ...
        <div className="media-toggle-grid">
          ...
          <button className={`toggle-btn ${media.mic ? 'toggle-on' : 'toggle-off'}`} onClick={() => toggleMedia('mic')}>
          ...
          <button className={`toggle-btn ${media.sound ? 'toggle-on' : 'toggle-off'}`} onClick={() => toggleMedia('sound')}>
            <div className="toggle-icon-wrap">
        ...
        {(media.camera || media.stream) && (
          <div className="media-summary">
            {media.camera && (
              <span className="summary-pill cam">📷 Sadece Kamera aktif</span>
            )}
            {media.stream && (
              <span className="summary-pill stream">📺 Sadece Yayın aktif</span>
            )}
          </div>
        )}
      </section>
